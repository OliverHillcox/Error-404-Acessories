...
public class clsDataConnection
{
    ...
    private string GetConString(string SomePath)
    {
        ...
        connectionString = "Data Source = (LocalDB)\\MSSQLLocalDB; AttachDbFilename = E:\\University\\Agile Development Stuff\\local DB Stuff\\Customer.mdf; Integrated Security = True; Connect Timeout = 30";
